...
object TestUtil {
    ...
    @JvmStatic val TEST_NOTE_1 = Note("Take out the trash", "It's garbage day tomorrow.", TIMESTAMP_1)

    const val TIMESTAMP_2 = "07-2022"
    @JvmStatic val TEST_NOTE_2 = Note("Anniversary gift", "Buy an anniversary gift.", TIMESTAMP_2)

    @JvmStatic val TEST_NOTES_LIST: List<Note> = listOf(
